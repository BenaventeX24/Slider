...
var Slider = function (_a) {
    var children = _a.children, styles = _a.styles, spacing = _a.spacing, buttonLeft = _a.buttonLeft, buttonRight = _a.buttonRight, threshold = _a.threshold, time = _a.time, width = _a.width, sliderContainerStyles = _a.sliderContainerStyles, itemsContainerStyles = _a.itemsContainerStyles, buttonLeftStyles = _a.buttonLeftStyles, buttonRightStyles = _a.buttonRightStyles, _b = _a.disableScrollbar, disableScrollbar = _b === void 0 ? false : _b, _c = _a.showButtons, showButtons = _c === void 0 ? true : _c, _d = _a.disappearingButtons, disappearingButtons = _d === void 0 ? true : _d;
    ...
    (0, react_1.useEffect)(function () {
        ...
        var align = scrollTo.direction === utils_1.slideDirections.RIGHT ? 0.001 : 1;
    ...
    return ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsxs)(SliderContainer_1.default, __assign({ setVisibleButtons: setVisibleButtons, sliderContainerStyles: sliderContainerStyles }, { children: [buttonLeft ? ((0, jsx_runtime_1.jsx)(UserCustomButton_1.default, __assign({ disappearingButtons: disappearingButtons, disabled: disableButtons, visible: visibleButtons, locked: lockSlide, onClick: slideLeft, direction: utils_1.slideDirections.LEFT }, { children: buttonLeft }))) : ((0, jsx_runtime_1.jsx)(SliderButton_1.default, __assign({ disappearingButtons: disappearingButtons, disabled: disableButtons, visible: visibleButtons, locked: lockSlide, onClick: slideLeft, styles: buttonLeftStyles, direction: utils_1.slideDirections.LEFT }, { children: (0, jsx_runtime_1.jsx)(bs_1.BsChevronLeft, {}) }))), (0, jsx_runtime_1.jsx)(ItemsContainer_1.default, __assign({ width: width, disableScrollbar: disableScrollbar, itemsContainerStyles: itemsContainerStyles }, { children: react_1.Children.toArray(children).map(function (item, index) { return ((0, jsx_runtime_1.jsx)(Sensor_1.default, __assign({ spacing: spacing, threshold: threshold ? threshold : 1, ref: function (element) {
                            ...
                            return item;
                        } }), index)); }) })), buttonRight ? ((0, jsx_runtime_1.jsx)(UserCustomButton_1.default, __assign({ disappearingButtons: disappearingButtons, disabled: disableButtons, visible: visibleButtons, locked: lockSlide, onClick: slideRight, direction: utils_1.slideDirections.RIGHT }, { children: buttonRight }))) : ((0, jsx_runtime_1.jsx)(SliderButton_1.default, __assign({ disappearingButtons: disappearingButtons, disabled: disableButtons, visible: visibleButtons, locked: lockSlide, onClick: slideRight, styles: buttonRightStyles, direction: utils_1.slideDirections.RIGHT }, { children: (0, jsx_runtime_1.jsx)(bs_1.BsChevronRight, {}) })))] })) }));
};
