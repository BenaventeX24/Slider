...
var Sensor = function (_a, ref) {
    ...
    var _b = (0, react_intersection_observer_1.useInView)({ threshold: [0.98] }), upperRef = _b[0], isUpperVisible = _b[1];
    var _c = (0, react_intersection_observer_1.useInView)({ threshold: [0.98] }), lowerRef = _c[0], isLowerVisible = _c[1];
    var _d = (0, react_intersection_observer_1.useInView)({ threshold: [0.98] }), middleRef = _d[0], isMiddleVisible = _d[1];
