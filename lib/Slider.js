...
var Slider = function (_a) {
    ...
    var evaluteButtonsLock = function () {
        setTimeout(function () {
            ...
            if (((_a = itemsRef.current[0]) === null || _a === void 0 ? void 0 : _a.inView) === true) {
                setLockSlide(utils_1.slideDirections.LEFT);
            }
            if (((_b = itemsRef.current[itemsRef.current.length - 1]) === null || _b === void 0 ? void 0 : _b.inView) === true)
                setLockSlide(utils_1.slideDirections.RIGHT);
            if (((_c = itemsRef.current[0]) === null || _c === void 0 ? void 0 : _c.inView) === true &&
                ((_d = itemsRef.current[itemsRef.current.length - 1]) === null || _d === void 0 ? void 0 : _d.inView) === true)
    ...
    var slideRight = function () {
        ...
        itemsRef.current.forEach(function (item, index) {
            ...
            if (item.inView)
                visibleItems++;
            if (item.inView &&
                (((_a = itemsRef.current[index + 1]) === null || _a === void 0 ? void 0 : _a.inView) === false ||
                    ((_b = itemsRef.current[index + 1]) === null || _b === void 0 ? void 0 : _b.inView) === undefined))
    ...
    var slideLeft = function () {
        ...
        itemsRef.current.forEach(function (item, index) {
            ...
            if (item.inView)
                visibleItems++;
            if (item.inView && ((_a = itemsRef.current[index - 1]) === null || _a === void 0 ? void 0 : _a.inView) === false) {
    ...
    return ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsxs)(SliderContainer_1.default, __assign({ id: id, setVisibleButtons: setVisibleButtons, outerContainerStyles: outerContainerStyles }, { children: [buttonLeft && showButtons ? ((0, jsx_runtime_1.jsx)(UserCustomButton_1.default, __assign({ disappearingButtons: disappearingButtons, disabled: disableButtons, visible: visibleButtons, locked: lockSlide, onClick: slideLeft, direction: utils_1.slideDirections.LEFT }, { children: buttonLeft }))) : ((0, jsx_runtime_1.jsx)(SliderButton_1.default, { disappearingButtons: disappearingButtons, disabled: disableButtons, visible: visibleButtons, locked: lockSlide, onClick: slideLeft, styles: buttonLeftStyles, direction: utils_1.slideDirections.LEFT })), (0, jsx_runtime_1.jsx)(ItemsContainer_1.default, __assign({ width: width, disableScrollbar: disableScrollbar, innerContainerStyles: innerContainerStyles }, { children: react_1.Children.toArray(children).map(function (item, index) { return ((0, jsx_runtime_1.jsx)(Sensor_1.default, __assign({ spacing: spacing, ref: function (element) {
                            itemsRef.current[index] = element;
                        } }, { children: function (inView) {
