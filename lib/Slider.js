...
var Slider = function (_a) {
    ...
    var slideRight = function () {
        ...
        if (scrollToRight + visibleItems >= itemsRef.current.length)
            setLockSlide(utils_1.slideDirections.RIGHT);
        if (visibleItems === 0)
            console.error("No visible items found. Try setting a smaller threshold, increasing slider's width or reducing item's width");
